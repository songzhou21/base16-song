...
" minimal light scheme by Song Zhou
...
hi clear
syntax reset
let g:colors_name = "base16-minimal"
...
call <sid>hi("Error",         s:gui0B, s:gui01, "", "")
call <sid>hi("ErrorMsg",      s:gui08, "", "", "")
...
call <sid>hi("Search",        s:gui08, s:gui02, "", "")
...
call <sid>hi("Visual",        "", s:gui_selection, "", "")
call <sid>hi("VisualNOS",     s:gui08, "", "", "")
call <sid>hi("WarningMsg",    s:gui08, "", "", "")
call <sid>hi("WildMenu",      s:gui00, s:gui_menu_select, "", "")
...
call <sid>hi("StatusLine",    s:gui07, s:gui02, "none", "")
...
call <sid>hi("Operator",     s:gui07, "", "none", "")
...
call <sid>hi("RubyPredefinedConstant",      s:gui0A, "", "", "")
...
call <sid>hi("rubyConditional",             s:gui0E, "", "", "")
call <sid>hi("rubyRepeat",                  s:gui0E, "", "", "")
call <sid>hi("rubyControl",                 s:gui0E, "", "", "")
...
call <sid>hi("SpellBad",     s:gui05, s:gui00, "undercurl", s:gui08)
call <sid>hi("SpellLocal",   s:gui05, s:gui00, "undercurl", s:gui0C)
call <sid>hi("SpellCap",     s:gui05, s:gui00, "undercurl", s:gui0D)
call <sid>hi("SpellRare",    s:gui05, s:gui00, "undercurl", s:gui0E)
