...
" Xcode-Default scheme by Song Zhou
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-xcode-default.sh"
  endif
endif
...
let s:gui01        = "f4f4f4"
let g:base16_gui01 = "f4f4f4"
let s:gui02        = "e4e4e4"
let g:base16_gui02 = "e4e4e4"
let s:gui03        = "939393"
let g:base16_gui03 = "939393"
let s:gui04        = "585858"
...
let s:gui08        = "000000"
let g:base16_gui08 = "000000"
let s:gui09        = "1C00CF"
let g:base16_gui09 = "1C00CF"
let s:gui0A        = "3F6E74"
let g:base16_gui0A = "3F6E74"
let s:gui0B        = "C41A16"
...
" custom
let s:gui_selection = "A4CDFF"
let s:gui_current_line = "E8F2FF"
let s:gui_menu_select = "116CD7"

" Theme setup
hi clear
syntax reset
let g:colors_name = "base16-xcode-default"
...
call <sid>hi("Error",         s:gui0B, s:gui01, s:cterm00, s:cterm08, "", "")
call <sid>hi("ErrorMsg",      s:gui08, "", s:cterm08, s:cterm00, "", "")
...
call <sid>hi("Search",        s:gui08, s:gui02, s:cterm03, s:cterm0A,  "", "")
call <sid>hi("Substitute",    s:gui03, s:gui0A, s:cterm03, s:cterm0A, "none", "")
call <sid>hi("SpecialKey",    s:gui03, "", s:cterm03, "", "", "")
call <sid>hi("TooLong",       s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("Underlined",    s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("Visual",        "", s:gui_selection, "", s:cterm02, "", "")
call <sid>hi("VisualNOS",     s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("WarningMsg",    s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("WildMenu",      s:gui00, s:gui_menu_select, s:cterm08, "", "", "")
...
call <sid>hi("StatusLine",    s:gui07, s:gui02, s:cterm04, s:cterm02, "none", "")
call <sid>hi("StatusLineNC",  s:gui04, s:gui01, s:cterm03, s:cterm01, "none", "")
call <sid>hi("VertSplit",     s:gui02, s:gui02, s:cterm02, s:cterm02, "none", "")
call <sid>hi("ColorColumn",   "", s:gui01, "", s:cterm01, "none", "")
call <sid>hi("CursorColumn",  "", s:gui01, "", s:cterm01, "none", "")
call <sid>hi("CursorLine",    "", s:gui_current_line, "", s:cterm01, "none", "")
call <sid>hi("CursorLineNr",  s:gui04, s:gui01, s:cterm04, s:cterm01, "", "")
call <sid>hi("QuickFixLine",  "", s:gui01, "", s:cterm01, "none", "")
call <sid>hi("PMenu",         s:gui05, s:gui00, s:cterm05, s:cterm01, "none", "")
call <sid>hi("PMenuSel",      s:gui00, s:gui_menu_select, s:cterm01, s:cterm05, "", "")
...
unlet s:gui_selection s:gui_current_line s:gui_menu_select
